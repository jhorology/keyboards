...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_68_ansi_split_bs_and_rshift(
    ...
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, MO(2),      DIAL_BUT,
    APFF_EJ, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_RALT, MO(3),                DIAL_L, KC_MPLY, DIAL_R
  ),
  // standard base layer
  ...
  [3] = LAYOUT_68_ansi_split_bs_and_rshift(
    ...
    _______, MAC_ON,  USJ_OFF, NK_ON,   CL_NORM, AG_NORM, _______, _______, _______, _______, _______, _______,          _______,
