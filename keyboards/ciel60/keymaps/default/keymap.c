...
#define APFF_EJ TD(TD_APFF_EISU_KANA)  // Left Command, on tap: KC_LNG2(英数), on double tap: KC_LNG1(かな)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_60_tsangan_hhkb(
    ...
    APFF_EJ, KC_LALT, KC_LGUI,                            KC_SPC,                                               KC_RGUI, KC_RALT, MO(3)
  ),
  // standard base layer
  ...
  [3] = LAYOUT_60_tsangan_hhkb(
    ...
    CL_TOGG, MAC_ON,  USJ_OFF, NK_ON,   _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
    _______,          MAC_OFF, USJ_ON,  NK_OFF,  _______, _______, _______, _______, _______, _______, _______,          _______, _______,
    _______, _______, AG_TOGG,                            _______,                                              _______, _______, _______
  )
};
// clang-format on
