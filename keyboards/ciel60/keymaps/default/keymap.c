...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_60_tsangan_hhkb(
    ...
    APPLE_FF,TD(ALT_IME), KC_LGUI,                           KC_SPC,                                               KC_RGUI, KC_RALT, MO(2)
  ),
  ...
  [2] = LAYOUT_60_tsangan_hhkb(
    ...
    CL_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
