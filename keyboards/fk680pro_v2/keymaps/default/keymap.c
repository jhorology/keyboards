...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  (
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_LSFT, MO(1),   KC_NO,
   APPLE_FF,TD(ALT_IME),KC_LGUI,                KC_SPC,                             KC_RGUI, KC_RALT, MO(2),   KC_MPRV, KC_MPLY, KC_MNXT
   ),
  [1] = LAYOUT
  (
  ...
  (
   ...
   CL_TOGG, RGB_CYMD,RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, _______, _______, _______, _______, _______, _______,          _______, _______,
