...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT
  (
   KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, DIAL_BUT,
   KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC, DIAL_R,
   KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  DIAL_L,
  ...
  (
   ...
   CL_TOGG, MAC_ON,  USJ_OFF, NK_ON,   _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
   _______, MAC_OFF, USJ_ON,  NK_OFF,  _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
