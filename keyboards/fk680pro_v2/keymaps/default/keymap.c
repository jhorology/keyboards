...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  (
   ...
   _______, MAC_ON,  USJ_OFF, NK_ON,   CL_NORM, AG_NORM, _______, _______, _______, _______, _______, _______,          _______, _______,
   _______, MAC_OFF, USJ_ON,  NK_OFF,  CL_SWAP, AG_SWAP, _______, _______, _______, _______, _______,          _______, _______, _______,
   _______, _______, _______,                   _______,                            _______, _______, _______, _______, _______, _______
   )
};
// clang-format on
