...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    (
     ...
     KC_APFN, KC_LGUI,                   KC_LALT, MO1_SPC,     SFT_SPC, MO(2),                              MO(3),   MO(4)
     ),
    ...
    [2] = LAYOUT
    (
     KC_CAPS, KC_VOLD, KC_VOLU, KC_MUTE, KC_EJCT, _______,    _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   KC_INS,  KC_DEL,
     RGB_TOG, RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, KC_PAST,    KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, KC_PENT,
    ...
    [4] = LAYOUT
    (
     _______, _______, _______, _______, _______, _______,     _______, KC_F16, KC_F17,   KC_F18,  _______, _______, RESET,
