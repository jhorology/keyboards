...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_ESC, DIAL_BUT,
    ...
    APFF_EJ, KC_LALT, KC_LGUI,                            KC_SPC,                    MO(3),                     KC_MPRV, KC_MPLY, KC_MNXT
  ),
  // mac base layer
