...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    APFF_EJ, KC_LGUI,                   KC_LALT, MO2_SPC,     SFT_SPC, MO(3),                              KC_RGUI, MO(4)
  ),
  ...
  [4] = LAYOUT(
    ...
    _______, MAC_ON,  USJ_OFF, NK_ON,   CL_NORM, AG_NORM,     RGB_TOG, RGB_VAI, RGB_HUI, _______, _______, _______,
    _______, MAC_OFF, USJ_ON,  NK_OFF,  CL_SWAP, AG_SWAP,     RGB_MOD, RGB_SPI, RGB_SAI, _______, _______, _______, _______,
