...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_tsangan_hhkb(
        ...
        XXXXXXX,  KC_LALT,  KC_LGUI,                                KC_SPC,                                           KC_RGUI,  APPLE_FN, XXXXXXX
    ),
    ...
    [2] = LAYOUT_60_tsangan_hhkb(
        ...
        _______,  RGB_TOG,  RGB_VAI,  RGB_SPI,  RGB_HUI,  RGB_SAI,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
