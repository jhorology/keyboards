      ...
      content: [
        {
          ...
          type: 'toggle',
          content: ['id_custom_magic_swap_control_capslock', ID_CUSTOM_MAGIC_CHANNEL, 1]
        },
        {
          label: 'Swap Caps Lock and Escape',
          type: 'toggle',
          content: ['id_custom_magic_swap_escape_capslock', ID_CUSTOM_MAGIC_CHANNEL, 2]
        },
        {
          label: 'Treat Caps Lock as Control',
          type: 'toggle',
          content: ['id_custom_magic_capslock_to_control', ID_CUSTOM_MAGIC_CHANNEL, 3]
        },
        {
          label: 'Swap Left Control and GUI',
          type: 'toggle',
          content: ['id_custom_magic_swap_lctl_lgui', ID_CUSTOM_MAGIC_CHANNEL, 4]
        },
        {
          label: 'Swap Right Control and GUI',
          type: 'toggle',
          content: ['id_custom_magic_swap_rctl_rgui', ID_CUSTOM_MAGIC_CHANNEL, 5]
        },
        {
          label: 'Swap Left Alt and GUI',
          type: 'toggle',
          content: ['id_custom_magic_swap_lalt_lgui', ID_CUSTOM_MAGIC_CHANNEL, 6]
        },
        {
          label: 'Swap Right Alt and GUI',
          type: 'toggle',
          content: ['id_custom_magic_swap_ralt_rgui', ID_CUSTOM_MAGIC_CHANNEL, 7]
        },
        {
        ...
        },
        {
          ...
          type: 'toggle',
          content: ['id_custom_magic_swap_grave_esc', ID_CUSTOM_MAGIC_CHANNEL, 9]
        },
        {
  ...
  content: [
    {
      ...
      content: [
        ...
        },
        {
          ...
          type: 'toggle',
          content: ['id_custom_rc_fine_tune_mod_apple_fn', ID_CUSTOM_RC_CHANNEL, 8]
        }
      ]
    }
  ]
...
function createTapDanceMenu(size) {
  ...
  return {
    ...
    content: _.range(size).map((i) => ({
      label: 'TD' + i + ' - 0x57' + i.toString(16).toUpperCase().padStart(2, '0'),
      content: [
        {
          label: 'Single Tap',
          type: 'keycode',
          content: [`id_custom_td_${i}_single_tap`, ID_CUSTOM_TD_CHANNEL_START + i, 1]
        },
        {
          label: 'Hold',
          type: 'keycode',
          content: [`id_custom_td_${i}_single_hold`, ID_CUSTOM_TD_CHANNEL_START + i, 2]
        },
        {
          label: 'Double Tap',
          type: 'keycode',
          content: [`id_custom_td_${i}_multi_tap`, ID_CUSTOM_TD_CHANNEL_START + i, 3]
        },
        {
          label: 'Tap Hold',
          type: 'keycode',
          content: [`id_custom_td_${i}_tap_hold`, ID_CUSTOM_TD_CHANNEL_START + i, 4]
        },
        {
          label: 'Tapping Term: (50 - 1000 ms)',
          type: 'range',
          options: [50, 1000],
          content: [`id_custom_td_${i}_tapping_term`, ID_CUSTOM_TD_CHANNEL_START + i, 5]
        }
      ]
    }))
  }
    ...
    content: [
      {
        ...
        content: [
          {
            label:
              'Auto-detect mac/non-mac mode' + (hasDipSwitch ? ' *(dip-switch will not work)' : ''),
            type: 'toggle',
            content: ['id_custom_non_mac_fn_auto_detect', ID_CUSTOM_NON_MAC_FN_CHANNEL, 1]
          },
          {
            label: 'When mac mode is disabled, fn🌐 key apply to F1-12 keys',
            type: 'toggle',
            content: ['id_custom_non_mac_fn_fkey', ID_CUSTOM_NON_MAC_FN_CHANNEL, 2]
          },
          {
            label: 'When mac mode is disabled, fn🌐 key apply to alpha keys',
            type: 'toggle',
            content: ['id_custom_non_mac_fn_alpha', ID_CUSTOM_NON_MAC_FN_CHANNEL, 3]
          },
          {
            label: 'When mac mode is disabled, fn🌐 key apply to cursor keys',
            type: 'toggle',
            content: ['id_custom_non_mac_fn_cursor', ID_CUSTOM_NON_MAC_FN_CHANNEL, 4]
          },
          ...[
            ...
            type: 'keycode',
            content: [
              `id_custom_non_mac_fn_${e.key.toLowerCase().replaceAll(' ', '_')}`,
