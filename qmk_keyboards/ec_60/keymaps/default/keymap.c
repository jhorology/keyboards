...
const uint16_t PROGMEM ec_bottoming_reading_default[MATRIX_ROWS][MATRIX_COLS] = {
  {0x0211,0x0253,0x0250,0x02f8,0x0276,0x021d,0x0223,0x0213,0x0227,0x01e4,0x021f,0x024c,0x0274,0x0195,0x022d},
  {0x025b,0x02a9,0x02e7,0x0340,0x02a0,0x02ee,0x026c,0x0256,0x02f9,0x02b2,0x0276,0x0299,0x020f,0x01c0,0x03ff},
  {0x019b,0x02db,0x02df,0x030a,0x0291,0x02d3,0x02ac,0x02ae,0x02f3,0x02a2,0x0288,0x02ca,0x03ff,0x027b,0x03ff},
  {0x01a4,0x03ff,0x0275,0x0306,0x02ff,0x02a8,0x0264,0x0302,0x0333,0x0282,0x02d5,0x0278,0x03ff,0x01a6,0x0232},
  {0x01c9,0x01f1,0x01c0,0x03ff,0x03ff,0x03ff,0x01da,0x03ff,0x03ff,0x03ff,0x017f,0x0198,0x01b3,0x03ff,0x03ff}
};
// clang-format on
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_60_tsangan(
    ...
    _______, EC_CALD, EC_PSET, EC_PMAP, _EC_DBG, _______, _______, _______, _______, _______, _______, _______, TEST_OS,          _______,
