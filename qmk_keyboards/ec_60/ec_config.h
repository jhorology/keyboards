...
/* eeprom address */
#define EC_VIA_EEPROM_PRESETS_OFFSET VIA_EEPROM_CUSTOM_CONFIG_USER_OFFSET
#define EC_VIA_EEPROM_BOTTOMING_READING_OFFSET \
  (EC_VIA_EEPROM_PRESETS_OFFSET + sizeof(ec_preset_t) * EC_NUM_PRESETS)
#define EC_VIA_EEPROM_NOISE_FLOOR_OFFSET \
  (EC_VIA_EEPROM_BOTTOMING_READING_OFFSET + 2 * MATRIX_ROWS * MATRIX_COLS)
#define EC_VIA_EEPROM_PRESET_MAP_OFFSET \
  (EC_VIA_EEPROM_NOISE_FLOOR_OFFSET + 2 * MATRIX_ROWS * MATRIX_COLS)
