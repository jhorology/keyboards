...
static void unselect_col(uint8_t col) { HC595_output(0xFFFF); }

static void unselect_cols(void) { HC595_output(0xFFFF); }

void select_all_cols(void) { HC595_output(0x0000); }
