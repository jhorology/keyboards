...
__attribute__((weak)) void battery_measure(void) { ckbt51_read_state_reg(0x05, 0x02); }

/* Calculate the voltage */
__attribute__((weak)) void battery_calculate_voltage(uint16_t value) {}

void battery_set_voltage(uint16_t value) { voltage = value; }

uint16_t battery_get_voltage(void) { return voltage; }
...
bool battery_is_empty(void) { return bat_empty > BATTERY_EMPTY_COUNT; }

bool battery_is_critical_low(void) { return critical_low > CRITICAL_LOW_COUNT; }
...
bool battery_power_on_sample(void) { return power_on_sample < VOLTAGE_POWER_ON_MEASURE_COUNT; }
