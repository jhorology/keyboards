...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  (
   ...
   APPLE_FF, KC_LALT, TD(0),                     KC_SPC,                             TD(1),   KC_RALT, TD(2),   KC_MPRV, KC_MPLY, KC_MNXT
  ),
  // standard base layer
  [1] = LAYOUT
  (
  ...
  (
   ...
   _______, RGB_TOGX,RM_VALU, RM_HUEU, _______, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,          KC_PENT, _______,
   _______, RM_NEXT, RM_SPDU, RM_SATU, _______, _______, KC_PPLS, KC_PMNS, KC_END,  KC_PGDN, KC_DOWN,          _______, _______, _______,
